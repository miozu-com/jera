...
const COMPONENT_URL = `${STORYBOOK_URL}/docs/components/distribution-bar/`;

test.describe("distributionbar", () => {

  test("distributionbar / L4 mobile (375×812) — text_readable", async ({ page }) => {
    // L4 Responsive — mobile 375×812 — check: text_readable
    // Fix: fail: font-size 10px on "45"
  ...
  test("distributionbar / L4 tablet (768×1024) — text_readable", async ({ page }) => {
  ...
  test("distributionbar / L4 desktop (1440×900) — text_readable", async ({ page }) => {
