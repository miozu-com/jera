...
// Auto-generated from run_id: run-1777064213040
...
const COMPONENT_URL = `${STORYBOOK_URL}/docs/components/badge/`;

test.describe("badge", () => {

  test("badge / secondary / light — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
    // Measured: 3.98:1  Required: 4.5:1  FG: rgb(0,127,146)  BG: rgb(225,238,242)  Font: 12px
    // Fix: Contrast ratio 3.98:1 below WCAG AA minimum of 4.5:1
    await page.goto(COMPONENT_URL);
    await page.waitForSelector('.preview-area', { timeout: 15000 });
    await page.waitForTimeout(500);
    await page.selectOption('.controls-panel select.jera-select', "secondary").catch(() => {});
  ...
  var el = preview.querySelector("[class*=\"jera-badge\"]")
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / secondary / light`)
      .toBeGreaterThanOrEqual(result!.required);
  });

  test("badge / success / light — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
    // Measured: 3.77:1  Required: 4.5:1  FG: rgb(0,138,62)  BG: rgb(225,239,233)  Font: 12px
    // Fix: Contrast ratio 3.77:1 below WCAG AA minimum of 4.5:1
    await page.goto(COMPONENT_URL);
    await page.waitForSelector('.preview-area', { timeout: 15000 });
    await page.waitForTimeout(500);
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result, 'Could not locate jera element for contrast measurement').not.toBeNull();
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / success / light`)
      .toBeGreaterThanOrEqual(result!.required);
  });

  test("badge / warning / light — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result, 'Could not locate jera element for contrast measurement').not.toBeNull();
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / warning / light`)
      .toBeGreaterThanOrEqual(result!.required);
  });

  test("badge / error / light — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
    // Measured: 4.44:1  Required: 4.5:1  FG: rgb(204,39,46)  BG: rgb(246,229,232)  Font: 12px
    // Fix: Contrast ratio 4.44:1 below WCAG AA minimum of 4.5:1
    await page.goto(COMPONENT_URL);
    await page.waitForSelector('.preview-area', { timeout: 15000 });
    await page.waitForTimeout(500);
    await page.selectOption('.controls-panel select.jera-select', "error").catch(() => {});
    await page.waitForTimeout(300);
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result, 'Could not locate jera element for contrast measurement').not.toBeNull();
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / error / light`)
      .toBeGreaterThanOrEqual(result!.required);
  });

  test("badge / primary / dark — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
    // Measured: 4.39:1  Required: 4.5:1  FG: rgb(86,150,255)  BG: rgb(40,50,72)  Font: 12px
    // Fix: Contrast ratio 4.39:1 below WCAG AA minimum of 4.5:1
    await page.goto(COMPONENT_URL);
    await page.waitForSelector('.preview-area', { timeout: 15000 });
    await page.waitForTimeout(500);
    await page.selectOption('.controls-panel select.jera-select', "primary").catch(() => {});
    await page.waitForTimeout(300);
    // Enable dark mode
    await page.evaluate(() => {
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result, 'Could not locate jera element for contrast measurement').not.toBeNull();
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / primary / dark`)
      .toBeGreaterThanOrEqual(result!.required);
  });

  test("badge / info / dark — L1 contrast ratio must meet WCAG AA (1.4.3)", async ({ page }) => {
    // Canvas-sampled contrast — axe marks oklch tokens as 'incomplete', we detect via pixel sampling
    // Measured: 4.39:1  Required: 4.5:1  FG: rgb(86,150,255)  BG: rgb(40,50,72)  Font: 12px
    // Fix: Contrast ratio 4.39:1 below WCAG AA minimum of 4.5:1
    await page.goto(COMPONENT_URL);
  ...
  return { ratio: ratio, required: required, fg: "rgb("+fg+")", bg: "rgb("+bg+")" };
    ...
    expect(result, 'Could not locate jera element for contrast measurement').not.toBeNull();
    expect(result!.ratio,
      `Contrast ${result!.ratio}:1 must meet WCAG AA (${result!.required}:1) — badge / info / dark`)
      .toBeGreaterThanOrEqual(result!.required);
  });
});
