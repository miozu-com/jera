...
test.describe("distribution-bar", () => {
  ...
  test("distribution-bar / L4 mobile (375×812) — text_readable", async ({ page }) => {
  ...
  test("distribution-bar / L4 tablet (768×1024) — text_readable", async ({ page }) => {
  ...
  test("distribution-bar / L4 desktop (1440×900) — text_readable", async ({ page }) => {
